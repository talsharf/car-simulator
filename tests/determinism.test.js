...
class DeterministicMockVehicle {
    constructor() {
        this.state = {
            timestamp: 0,
    ...
    getTelemetryFromLastStep() { return {}; }
}
class MockEnvironment {
    getGravity() { return { x: 0, y: 0, z: -9.81 }; }
    getGroundHeight(x, y) { return 0; }
    getGroundNormal(x, y) { return { x: 0, y: 0, z: 1 }; }
}
